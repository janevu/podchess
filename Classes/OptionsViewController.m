...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath 
{
    ...
    if (indexPath.row == 0) {
        ...
        [((PodChessAppDelegate*)[[UIApplication sharedApplication] delegate]).navigationController pushViewController:genericController animated:YES];
    ...
    if (indexPath.row == 1) {
        ...
        [((PodChessAppDelegate*)[[UIApplication sharedApplication] delegate]).navigationController pushViewController:aiController animated:YES];
